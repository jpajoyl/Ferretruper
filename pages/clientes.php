															...
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	<div class="modal-header">
																		<h5 class="modal-title" id="titleAñadirProveedor">Añadir a un nuevo cliente</h5>
																		...
																		<form autocomplete="off" action="#" id="form-añadirCliente">
																			<div class="form-row">
																				<div class="form-group col-md-6">
																					...
																					<input type="text" class="form-control" id="input-id" placeholder="Identificacion" autocomplete="off" required>
																				</div>
																				<div class="form-group col-md-6">
																					<label>Digito de verificación (Opcional)</label>
																					<input type="number" class="form-control" id="input-digito-de-verificacion" placeholder="Dig. de verificación" autocomplete="off">
																				</div>
																			</div>
																			...
																			<div class="form-group">
																				...
																				<input type="email" class="form-control" id="input-email" placeholder="Email" autocomplete="off">
																			</div>
																			<div class="form-row">
																				<div class="form-group col-md-6">
