...
<head>
		...
		<title>Ferretruper || Principal</title>
		...
		<link href="../assets/css/customCSS/index.css" rel="stylesheet" type="text/css" />		
				...
				<div class="row">
						<div class="col-xl-12">
								<div class="breadcrumb-holder">
										<h1 class="main-title float-left">Bienvenido <?php echo $empleado->getNombre(); ?></h1>
...
<script src="../assets/js/pagesJS/index.js"></script>
